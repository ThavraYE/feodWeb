...
function TableComponent(  { program, teacherEducation, principalEducation, linktablesate, onlinktablesate }) {
    return   <div className=" w-1/2 flex flex-col items-center justify-center ">
                ...
                <table className="m-4 border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td onClick={(message) => handleClick(linktablesate,onlinktablesate)} className="p-4 border hover:underline cursor-pointer">{teacherEducation[1]}</td>
                      <td onClick={(message) => handleClick(linktablesate,onlinktablesate)} className="p-4 border hover:underline cursor-pointer">{principalEducation[1]}</td>
                    </tr>
