      ...
      <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6  ">
            {images.map((item,index)=>(
              (index==0) ?
              <div key={index} onClick={()=>handleViewMore(item)} className=" lg:col-span-2 group relative overflow-hidden shadow-sm rounded-xl h-[500px] ms-6 duration-600 hover:shadow-xl/30">
                <img  src={item.src}
                     alt="Green Energy" 
